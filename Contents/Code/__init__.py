...
WebsiteURL = 'http://www.hotstar.com/channels/star-vijay'
http = 'http:'
# This variable it to make an id below work as a url link
WebsiteEpURL = 'http://www.hotstar.com/channels/star-vijay/watch/'
BASE_URL = "http://www.hotstar.com/channels/star-vijay"
BASE_R_URL = "http://tiny.cc/3zkq7x"
...
# Important Note: (R stands for Resources folder) to tell the channel where these images are located.
  ...
  HTTP.Headers['Referer'] = 'http://www.hotstar.com/channels/star-vijay'
